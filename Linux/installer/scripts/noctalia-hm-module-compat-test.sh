...
WAHRWELT_NOCTALIA_TEST_REPO_ROOT="$repo_root" \
  ...
  nix eval --option abort-on-warn true --impure --json --file "$script_dir/noctalia-hm-module-compat.nix"

printf 'OK Noctalia Home Manager mixed-version module ownership without evaluation warnings\n'
