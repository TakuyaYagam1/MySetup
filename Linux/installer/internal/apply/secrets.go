...
func isThinWrapperFlake(text string) bool {
	return strings.Contains(text, "mysetup.lib.mkMySetupHost") ||
		containsMySetupNixOSFlakeURL(text)
}

func isGeneratedMySetupWrapperFlake(text string) bool {
	if strings.Contains(text, "# Generated by MySetup installer.") {
		return true
	}
	if !containsMySetupNixOSFlakeURL(text) {
		return false
	}
...
func containsMySetupNixOSFlakeURL(text string) bool {
