...
mysetup.bind_exec(v.kbSession, noctalia .. " session-menu-toggle")
mysetup.bind_exec(v.kbShowSidebar, noctalia .. " control-center-toggle")
mysetup.bind_exec(v.kbClearNotifs, noctalia .. " notifications-clear", { locked = true })
mysetup.bind_exec(v.kbShowPanels, noctalia .. " settings-toggle")
mysetup.bind_exec(v.kbLock, noctalia .. " lock")
...
mysetup.bind_exec("SUPER + V", noctalia .. " clipboard-toggle")
mysetup.bind_exec("SUPER + ALT + V", noctalia .. " clipboard-toggle")
mysetup.bind_exec("SUPER + Period", noctalia .. " emoji-toggle")
